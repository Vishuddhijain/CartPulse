...
function RegisterForm({previousStep}:propType) {
  ...
  {/* Logo — centered, entrance animation + hover effect */}
<motion.div
  ...
  >
    ...
    >
      ...
      transition={{
       ...
       className='text-4xl font-extrabold text-green-700 mb-1 mt-0'>Create Account</motion.h1>
       <p className='text-gray-600 mb-8 flex items-center'>Join CartPulse today <Leaf className='w-5 h-5 text-green-600'/></p>
       <motion.form
