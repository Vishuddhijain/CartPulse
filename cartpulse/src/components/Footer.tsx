  ...
  return (
    ...
    >
        <div className='w-[90%] md:w-[80%] mx-auto py-10 grid grid-cols-1 md:grid-cols-3 gap-10 border-b border-green-500/40'>
          <div>
<h2  className='text-2xl font-bold mb-3'>CartPulse</h2>
...
<div>
     <h3 className="text-xl font-semibold mb-3">Contact Us</h3>
          <ul className="space-y-2 text-green-100 text-sm">
            ...
            <li className="flex items-center gap-2">
              <Mail size={16} /> support@cartpulse.in
            </li>
          </ul>
          {/* 🌐 Social Links */}
...
<div className="text-center py-4 text-sm text-green-100 bg-green-800/40">
        © {new Date().getFullYear()} <span className="font-semibold">CartPulse</span>. All rights reserved.
      </div>
